          ...
          >
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <div className="pt-4 space-y-2">
                <a href="https://wa.link/ov90du" className="block w-full py-3 bg-green-500 text-white rounded font-bold text-sm text-center">WHATSAPP</a>
                <a href="https://likebrasil.com.br/consultor/onathanoficial" className="block w-full py-3 bg-like-red text-white rounded font-bold text-sm text-center">CADASTRE-SE</a>
                <a href="https://likebrasil.com.br/consultor/onathanoficial" className="block w-full py-3 bg-like-dark text-white rounded font-bold text-sm text-center">ESCRITÓRIO</a>
              </div>
            </div>
          </motion.div>
        )}
